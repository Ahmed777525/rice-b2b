...
<head>
    <meta charset="UTF-8">
    <title>تقرير المنتجات - لوحة التحكم</title>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-9 col-lg-10 p-4">
                <h2 class="mb-4">تقرير المنتجات</h2>
                    ...
                    <div class="card-body">
                        <form method="GET" action="{{ route('admin.reports.products') }}" class="row g-3">
                            ...
                            <div class="col-md-4 d-flex align-items-end">
                                ...
                                <a href="{{ route('admin.reports.products') }}" class="btn btn-secondary">إعادة تعيين</a>
                            </div>
                        </form>
                    </div>
                </div>
                                ...
                                <tbody>
                                    @forelse($topProducts as $index => $product)
                                        <tr>
                                            ...
                                            <td>{{ number_format($product->total_revenue, 2) }} ر.س</td>
                                        </tr>
                                    @empty
                                        <tr>
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">المخزون المنخفض</h5>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="5" class="text-center">لا توجد مخزون منخفض</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
