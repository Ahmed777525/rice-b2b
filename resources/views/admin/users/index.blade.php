...
<head>
    ...
    <title>المستخدمون - لوحة التحكم</title>
        ...
        <div class="row">
            <div class="col-md-3 col-lg-2 sidebar p-0">
                ...
                <div class="sidebar-menu">
                    ...
                    <a href="{{ route('admin.users.index') }}" class="active"><i class="fas fa-users"></i><span>المستخدمون</span></a>
                    ...
                    <div class="card-body">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                @empty
                                <tr><td colspan="7" class="text-center py-4">لا يوجد مستخدمين</td></tr>
                                @endforelse
                            </tbody>
                        </table>
                        {{ $users->links() }}
